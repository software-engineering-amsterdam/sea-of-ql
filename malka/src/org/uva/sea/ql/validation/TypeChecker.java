...
public class TypeChecker implements Visitor {
	 ...
	 */
	public boolean checkTypes(Form form) throws VisitorException {
		VariableListGenerator variable_list_generator;
		
		variable_list_generator = new VariableListGenerator();
		variables = variable_list_generator.getVariableList(form);
	...
	@Override
	public void visit(FormText form_text)  throws VisitorException {
	...
	@Override
	public void visit(Eq relation) throws VisitorException {
	...
	@Override
	public void visit(GT relation) throws VisitorException {
		if (expressionsHaveSameType(relation.getLeftOperand(), relation.getRightOperand()))
			this.addError("Comparison of two different types", COMPARE_DIFFERENT_TYPES);
	}

	@Override
	public void visit(GEq relation) throws VisitorException {
		if (expressionsHaveSameType(relation.getLeftOperand(), relation.getRightOperand()))
			this.addError("Comparison of two different types", COMPARE_DIFFERENT_TYPES);
	}

	@Override
	public void visit(LEq relation) throws VisitorException {
		if (expressionsHaveSameType(relation.getLeftOperand(), relation.getRightOperand()))
			this.addError("Comparison of two different types", COMPARE_DIFFERENT_TYPES);
	}

	@Override
	public void visit(NEq relation) throws VisitorException {
		if (expressionsHaveSameType(relation.getLeftOperand(), relation.getRightOperand()))
			this.addError("Comparison of two different types", COMPARE_DIFFERENT_TYPES);
	}
	
	@Override
	public void visit(LT relation) throws VisitorException {
		if (expressionsHaveSameType(relation.getLeftOperand(), relation.getRightOperand()))
			this.addError("Comparison of two different types", COMPARE_DIFFERENT_TYPES);
	}
	...
	@Override
	public void visit(IntegerVariable variable) throws VisitorException {
		checkVariableConformDefinition(variable);
	}
	
	@Override
	public void visit(StringVariable variable) throws VisitorException {
		checkVariableConformDefinition(variable);
	}
	
	
	@Override
	public void visit(BooleanVariable variable) throws VisitorException {
		checkVariableConformDefinition(variable);
	}
	...
	@Override
	public void visit(And operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}

	@Override
	public void visit(Not operator) throws VisitorException {
		operator.getOperand().accept(this);
	}

	@Override
	public void visit(Or operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}
	
	@Override
	public void visit(Sub operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}

	@Override
	public void visit(Neg operator) throws VisitorException {
		operator.getOperand().accept(this);
	}

	@Override
	public void visit(Mul operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}

	@Override
	public void visit(Div operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}

	@Override
	public void visit(Add operator) throws VisitorException {
		operator.getLeftOperand().accept(this);
		operator.getRightOperand().accept(this);
	}

	@Override
	public void visit(Pos operator) throws VisitorException {
		operator.getOperand().accept(this);
	}
