// Output created by jacc on Sun Jan 27 16:12:34 CET 2013

package org.uva.sea.ql.parser.jacc;

import org.uva.sea.ql.ast.ASTNode;
import org.uva.sea.ql.ast.Assignment;
...
class QLParser implements QLTokens {
	...
	private int yyr14() { // expr : expr '*' expr
		{
			yyrv = new Multiply(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	}
	...
	private int yyr15() { // expr : expr '/' expr
		{
			yyrv = new Divide(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr16() { // expr : expr '+' expr
		{
			yyrv = new Add(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr17() { // expr : expr '-' expr
		{
			yyrv = new Substitute(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr18() { // expr : expr EQ expr
		{
			yyrv = new Equals(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr19() { // expr : expr NEQ expr
		{
			yyrv = new NotEquals(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr20() { // expr : expr '>' expr
		{
			yyrv = new GreaterThan(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr21() { // expr : expr '<' expr
		{
			yyrv = new SmallerThan(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr22() { // expr : expr GEQ expr
		{
			yyrv = new GreaterOrEquals(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr23() { // expr : expr LEQ expr
		{
			yyrv = new SmallerOrEquals(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr24() { // expr : expr AND expr
		{
			yyrv = new And(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr25() { // expr : expr OR expr
		{
			yyrv = new Or(((Expression) yysv[yysp - 3]),
					((Expression) yysv[yysp - 1]));
		}
		yysv[yysp -= 3] = yyrv;
		return yypexpr();
	...
	private int yyr33() { // ifStm : IF '(' expr ')' '{' compound '}'
		{
			yyrv = new IfStatement(((Expression) yysv[yysp - 5]),
					((CompoundStatement) yysv[yysp - 2]));
		}
		yysv[yysp -= 7] = yyrv;
		return 44;
	}
	...
	private int yyr6() { // question : dType IDENT '=' STRING_LIT
		{
			yyrv = new Question(yysv[yysp - 4], yysv[yysp - 3],
					((StringLiteral) yysv[yysp - 1]));
		}
		yysv[yysp -= 4] = yyrv;
		switch (yyst[yysp - 1]) {
		case 40:
	...
	public QLParser(final QLLexer lexer) {
		this.lexer = lexer;
	}
