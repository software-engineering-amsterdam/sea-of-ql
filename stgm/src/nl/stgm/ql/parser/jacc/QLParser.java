...
class QLParser implements QLTokens {
    ...
    private nl.stgm.ql.ast.ASTNode[] yysv;
    private nl.stgm.ql.ast.ASTNode yyrv;

    public boolean parse() {
        int yyn = 0;
        yysp = 0;
        yyst = new int[yyss];
        yysv = new nl.stgm.ql.ast.ASTNode[yyss];
    ...
    protected void yyexpand() {
        ...
        nl.stgm.ql.ast.ASTNode[] newyysv = new nl.stgm.ql.ast.ASTNode[2*yyst.length];
