...
// on woensdag 16 januari 2013 at 15:13:32.
...
public final class QLParser extends ParserBase {
  ...
  /**
   * Parse nonterminal nl.stgm.ql.parser.rats.QLParser.ParseDoc.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pParseDoc(final int yyStart) throws IOException {
    Result     yyResult;
    Document   yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pFormItem(final int yyStart) throws IOException {
    ...
    yyResult = pFormItem$$Choice1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
   ...
   * nl.stgm.ql.parser.rats.QLParser.FormItem$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pFormItem$$Choice1(final int yyStart) throws IOException {
    Result     yyResult;
    FormItem   yyValue;
    ParseError yyError = ParseError.DUMMY;
