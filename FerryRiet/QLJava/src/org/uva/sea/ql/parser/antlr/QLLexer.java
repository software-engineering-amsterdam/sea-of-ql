// $ANTLR 3.5 QL.g 2013-01-15 12:35:04
...
public class QLLexer extends Lexer {
	...
	public final void mBooleanLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// QL.g:126:5: ( 'true' | 'false' | 'TRUE' | 'FALSE' )
			int alt5=4;
			switch ( input.LA(1) ) {
			case 't':
				{
	...
	public final void mIdent() throws RecognitionException {
		try {
			int _type = Ident;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// QL.g:129:6: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// QL.g:129:10: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
	...
	public void mTokens() throws RecognitionException {
		// QL.g:1:8: ( T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | WS | StringLiteral | COLON | LBRACE | RBRACE | COMMENT | BooleanLiteral | Ident | IntLiteral )
		int alt8=30;
