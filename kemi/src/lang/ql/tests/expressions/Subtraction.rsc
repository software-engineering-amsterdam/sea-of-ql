...
public test bool testSub3() = parseExpr("(a - b - c)") is sub;
public test bool testSub4() = parseExpr("a - (b - c)") is sub;
public test bool testSub5() = parseExpr("(a - b) - c") is sub;
public test bool testSub6() = parseExpr("(a - b)") is sub;
public test bool testSub7() = parseExpr("a - b * c") is sub;
