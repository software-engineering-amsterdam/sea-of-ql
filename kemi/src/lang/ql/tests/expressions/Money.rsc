...
public test bool testRandomMul1() = parseExpr("<randomInt(100)>.<randomInt(9)><randomInt(9)>") is money;
public test bool testRandomMul2() = parseExpr("2.<randomInt(9)><randomInt(9)>") is money;
public test bool testRandomMul3() = parseExpr("<randomInt(100)>.<randomInt(9)>") is money;
