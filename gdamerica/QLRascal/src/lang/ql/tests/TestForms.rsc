...
private Form p(str src) 
	= implode(parseForm(src));

public test bool testForm1() 
	= p("form Box1HouseOwning{  }") is form;
public test bool testForm2() 
	= p("form Box1HouseOwning{ if (a || b) { name: \"test Question234:\" int } }") is form;
public test bool testForm3() 
	= p("form Box1HouseOwning{ 
