...
private Expr p(str src) 
	= implode(#Expr, parseExpression(src));
...
public test bool testString2() 
	= p("\"Test or not?\"") is strCon;
public test bool testString3() 
	= p("\"Test 12345#\"") is strCon;

public test bool testDate1() 
	= p("20/01/2013/") is date;

public test bool testDecimal1() 
	= p("2.123") is decimal;
public test bool testDecimal2() 
	= p("12.123") is decimal;
public test bool testDecimal3() 
	= p("1234568.123") is decimal;
...
public test bool testRel7() 
	= p("(a + b) \<= c") is leq;
public test bool testRel8() 
	= p("a \<= b") is leq;

public test bool testRel9() 
	= p("a + b \> c") is gt;
public test bool testRel10() 
	= p("a \> b + c") is gt;
public test bool testRel11() 
	= p("(a * b) \> c") is gt;
public test bool testRel12() 
	= p("(a \> b)") is gt;

public test bool testRel13() 
	= p("a + b \>= c") is geq;
public test bool testRel14() 
	= p("a \>= b + c") is geq;
public test bool testRel15() 
	= p("(a * b) \>= c") is geq;
public test bool testRel16() 
	= p("(a \>= b)") is geq;

public test bool testRel17() 
	= p("a * b == c") is eq;
public test bool testRel18() 
	= p("a == b + c") is eq;
public test bool testRel19() 
	= p("(a * b) == c") is eq;
public test bool testRel20() 
	= p("(a == b)") is eq;

public test bool testRel21() 
	= p("a * b != c") is neq;
public test bool testRel22() 
	= p("a != b + c") is neq;
public test bool testRel23() 
	= p("(a * b) != c") is neq;
public test bool testRel24() 
	= p("(a != b)") is neq;

public test bool testBoolOperator1() 
	= p("a * b && c") is and;
public test bool testBoolOperator2() 
	= p("(a * b) && c") is and;
public test bool testBoolOperator3() 
	= p("(a && b)") is and;
public test bool testBoolOperator4() 
	= p("a && b") is and;

public test bool testBoolOperator5() 
	= p("a * b || c") is or;
public test bool testBoolOperator6() 
	= p("(a * b) || c") is or;
public test bool testBoolOperator7() 
	= p("(a || b)") is or;
public test bool testBoolOperator8() 
	= p("a || b") is or;
