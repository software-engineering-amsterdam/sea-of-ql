...
// on woensdag 30 januari 2013 at 14:38:39.
                              ...
                              if (-1 != yyC) {
                                ...
                                if ('n' == yyC) {
                                  ...
                                  if (yyResult.hasValue()) {
                                    ...
                                    yyValue = new org.uva.sea.ql.ast.types.Bool();
                              ...
                              if (-1 != yyC) {
                                ...
                                if ('r' == yyC) {
                                  ...
                                  if (yyResult.hasValue()) {
                                    ...
                                    yyValue = new org.uva.sea.ql.ast.types.Int();
                          ...
                          if (-1 != yyC) {
                            ...
                            if ('g' == yyC) {
                              ...
                              if (yyResult.hasValue()) {
                                ...
                                yyValue = new org.uva.sea.ql.ast.types.Str();
  ...
  private Result pPrimary(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = new org.uva.sea.ql.ast.primitive.Str(s);
                  ...
                  if (-1 != yyC) {
                    ...
                    if ('e' == yyC) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyValue = new org.uva.sea.ql.ast.primitive.Bool(true);
                      ...
                      if (-1 != yyC) {
                        ...
                        if ('e' == yyC) {
                          ...
                          if (yyResult.hasValue()) {
                            ...
                            yyValue = new org.uva.sea.ql.ast.primitive.Bool(false);
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = new org.uva.sea.ql.ast.primitive.Int(Integer.parseInt(n));
