...
// on vrijdag 18 januari 2013 at 17:16:13.
...
public final class QLParser extends ParserBase {
              ...
              if (yyResult.hasValue()) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue()) {
                    ...
                    yyError  = yyResult.select(yyError);
                    if (yyResult.hasValue()) {
                      FormElement b = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal org.uva.sea.ql.parser.rats.QLParser.Body.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse org.uva.sea.ql.parser.rats.QLParser.Body. */
  private Result pBody$1(final int yyStart) throws IOException {
    ...
    yyResult = pBody$$Star1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Pair<FormElement> l = yyResult.semanticValue();

      yyValue= new Body(l.list());
   ...
   * org.uva.sea.ql.parser.rats.QLParser.Body$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBody$$Star1(final int yyStart) throws IOException {
    QLParserColumn yyColumn = (QLParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fBody$$Star1) 
      yyColumn.chunk1.fBody$$Star1 = pBody$$Star1$1(yyStart);
    return yyColumn.chunk1.fBody$$Star1;
  }

  /** Actually parse org.uva.sea.ql.parser.rats.QLParser.Body$$Star1. */
  private Result pBody$$Star1$1(final int yyStart) throws IOException {
    Result            yyResult;
    Pair<FormElement> yyValue;
    ParseError        yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pBodyNode(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      FormElement v$el$1 = yyResult.semanticValue();

      yyResult = pBody$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<FormElement> v$2 = yyResult.semanticValue();

        yyValue = new Pair<FormElement>(v$el$1, v$2);
  ...
  /**
   * Parse nonterminal org.uva.sea.ql.parser.rats.QLParser.BodyNode.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBodyNode(final int yyStart) throws IOException {
    Result      yyResult;
    FormElement yyValue;
    ParseError  yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal org.uva.sea.ql.parser.rats.QLParser.Branch.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBranch(final int yyStart) throws IOException {
    int         yyC;
    int         yyIndex;
    Result      yyResult;
    FormElement yyValue;
                ...
                if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue()) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      yyError  = yyResult.select(yyError);
                      if (yyResult.hasValue()) {
                        FormElement e = yyResult.semanticValue();

                        yyValue = new Branch(c,b,e);
    ...
    // Done.
    yyError = yyError.select("branch expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal org.uva.sea.ql.parser.rats.QLParser.Else.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
          ...
          if (yyResult.hasValue()) {
            ...
            if (':' == yyC) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  Expr t = yyResult.semanticValue();

                  yyResult = pSpacing(yyResult.index);
                  yyError  = yyResult.select(yyError);
                  if (yyResult.hasValue()) {

                    yyValue = new Question(q, new Ident(x), t);
  ...
  /**
   * Parse nonterminal org.uva.sea.ql.parser.rats.QLParser.TypeIn.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeIn(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    Expr       yyValue;
    ...
    // Done.
    yyError = yyError.select("type in expected", yyStart);
    return yyError;
  }
