...
// on dinsdag 22 januari 2013 at 15:35:44.
...
public final class QLParser extends ParserBase {
  ...
  /** Actually parse org.uva.sea.ql.parser.rats.QLParser.Literal. */
  private Result pLiteral$1(final int yyStart) throws IOException {
    ...
    if ('\"' == yyC) {
      ...
      yyResult = pLiteral$$Star1(yyIndex);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * org.uva.sea.ql.parser.rats.QLParser.Literal$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pLiteral$$Star1(final int yyStart) throws IOException {
    QLParserColumn yyColumn = (QLParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fLiteral$$Star1) 
      yyColumn.chunk2.fLiteral$$Star1 = pLiteral$$Star1$1(yyStart);
    return yyColumn.chunk2.fLiteral$$Star1;
  }

  /** Actually parse org.uva.sea.ql.parser.rats.QLParser.Literal$$Star1. */
  private Result pLiteral$$Star1$1(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    Void       yyValue;
