// $ANTLR 3.5 C:\\GIT\\sea-of-ql\\ruudvanderweijde\\sea-of-ql\\ruudvanderweijde\\src\\org\\uva\\sea\\ql\\parser\\QL.g 2013-01-15 16:24:26
...
public class QLParser extends Parser {
	...
	// $ANTLR start "form"
	// C:\\GIT\\sea-of-ql\\ruudvanderweijde\\sea-of-ql\\ruudvanderweijde\\src\\org\\uva\\sea\\ql\\parser\\QL.g:15:1: form returns [Form result] : 'form' Ident OBrace statements= block CBrace ;
	public final Form form() throws RecognitionException {
		...
		try {
			...
			// C:\\GIT\\sea-of-ql\\ruudvanderweijde\\sea-of-ql\\ruudvanderweijde\\src\\org\\uva\\sea\\ql\\parser\\QL.g:16:3: ( 'form' Ident OBrace statements= block CBrace )
			// C:\\GIT\\sea-of-ql\\ruudvanderweijde\\sea-of-ql\\ruudvanderweijde\\src\\org\\uva\\sea\\ql\\parser\\QL.g:16:5: 'form' Ident OBrace statements= block CBrace
			{
			...
			match(input,OBrace,FOLLOW_OBrace_in_form50); if (state.failed) return result;
			pushFollow(FOLLOW_block_in_form54);
			statements=block();
			state._fsp--;
			if (state.failed) return result;
			match(input,CBrace,FOLLOW_CBrace_in_form56); if (state.failed) return result;
	...
	public final List<Statement> block() throws RecognitionException {
		...
		try {
			...
			{
			match(input,OBrace,FOLLOW_OBrace_in_block88); if (state.failed) return result;
			...
			match(input,CBrace,FOLLOW_CBrace_in_block101); if (state.failed) return result;
			}
		...
		try {
			...
			switch (alt2) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_question_in_statement122);
					q=question();
					state._fsp--;
					if (state.failed) return result;
	...
	public final Statement ifStatement() throws RecognitionException {
		...
		try {
			...
			match(input,OParen,FOLLOW_OParen_in_ifStatement158); if (state.failed) return result;
			pushFollow(FOLLOW_orExpr_in_ifStatement162);
			condition=orExpr();
			state._fsp--;
			if (state.failed) return result;
			match(input,CParen,FOLLOW_CParen_in_ifStatement164); if (state.failed) return result;
			pushFollow(FOLLOW_block_in_ifStatement168);
			ifBlock=block();
			state._fsp--;
			if (state.failed) return result;
			...
			switch (alt3) {
				case 1 :
					...
					{
					match(input,Else,FOLLOW_Else_in_ifStatement181); if (state.failed) return result;
					pushFollow(FOLLOW_block_in_ifStatement185);
					elseBlock=block();
					state._fsp--;
					if (state.failed) return result;
					}
	...
	public final Statement question() throws RecognitionException {
		...
		try {
			...
			{
			Ident2=(Token)match(input,Ident,FOLLOW_Ident_in_question227); if (state.failed) return result;
			match(input,Colon,FOLLOW_Colon_in_question229); if (state.failed) return result;
			String3=(Token)match(input,String,FOLLOW_String_in_question231); if (state.failed) return result;
			pushFollow(FOLLOW_type_in_question235);
			tp=type();
			state._fsp--;
			if (state.failed) return result;
		...
		try {
			...
			switch (alt7) {
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_type254); if (state.failed) return result;
					...
					switch (alt4) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_computation_in_type264);
							cp=computation();
							state._fsp--;
							if (state.failed) return result;
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_type276); if (state.failed) return result;
					...
					switch (alt5) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_computation_in_type284);
							cp=computation();
							state._fsp--;
							if (state.failed) return result;
							if ( state.backtracking==0 ) { result.add(cp); }
				...
				case 3 :
					...
					{
					match(input,34,FOLLOW_34_in_type296); if (state.failed) return result;
					...
					switch (alt6) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_computation_in_type304);
							cp=computation();
							state._fsp--;
							if (state.failed) return result;
							if ( state.backtracking==0 ) { result.add(cp); }
	...
	public final Computation computation() throws RecognitionException {
		...
		try {
			...
			{
			match(input,OParen,FOLLOW_OParen_in_computation329); if (state.failed) return result;
			pushFollow(FOLLOW_orExpr_in_computation333);
			expr=orExpr();
			state._fsp--;
			if (state.failed) return result;
			match(input,CParen,FOLLOW_CParen_in_computation335); if (state.failed) return result;
		...
		try {
			...
			switch (alt8) {
				case 1 :
					...
					{
					Int4=(Token)match(input,Int,FOLLOW_Int_in_primary354); if (state.failed) return result;
				...
				case 2 :
					...
					{
					Ident5=(Token)match(input,Ident,FOLLOW_Ident_in_primary366); if (state.failed) return result;
				...
				case 3 :
					...
					{
					Bool6=(Token)match(input,Bool,FOLLOW_Bool_in_primary376); if (state.failed) return result;
				...
				case 4 :
					...
					{
					String7=(Token)match(input,String,FOLLOW_String_in_primary387); if (state.failed) return result;
				...
				case 5 :
					...
					{
					match(input,OParen,FOLLOW_OParen_in_primary396); if (state.failed) return result;
					pushFollow(FOLLOW_orExpr_in_primary400);
					x=orExpr();
					state._fsp--;
					if (state.failed) return result;
					match(input,CParen,FOLLOW_CParen_in_primary402); if (state.failed) return result;
		...
		try {
			...
			switch (alt9) {
				case 1 :
					...
					{
					match(input,24,FOLLOW_24_in_unExpr428); if (state.failed) return result;
				...
				case 2 :
					...
					{
					match(input,25,FOLLOW_25_in_unExpr443); if (state.failed) return result;
				...
				case 3 :
					...
					{
					match(input,20,FOLLOW_20_in_unExpr458); if (state.failed) return result;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					pushFollow(FOLLOW_unExpr_in_mulExpr533);
					rhs=unExpr();
					state._fsp--;
					if (state.failed) return result;
					if ( state.backtracking==0 ) { 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,22,FOLLOW_22_in_andExpr695); if (state.failed) return result;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,36,FOLLOW_36_in_orExpr740); if (state.failed) return result;
	...
	public final void synpred3_QL_fragment() throws RecognitionException {
		...
		{
		match(input,Else,FOLLOW_Else_in_synpred3_QL177); if (state.failed) return;
		}
	...
	public static final BitSet FOLLOW_OBrace_in_form50 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_block_in_form54 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_CBrace_in_form56 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OBrace_in_block88 = new BitSet(new long[]{0x0000000000000C20L});
	public static final BitSet FOLLOW_statement_in_block94 = new BitSet(new long[]{0x0000000000000C20L});
	public static final BitSet FOLLOW_CBrace_in_block101 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_question_in_statement122 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_OParen_in_ifStatement158 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_orExpr_in_ifStatement162 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_CParen_in_ifStatement164 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_block_in_ifStatement168 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_Else_in_ifStatement181 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_block_in_ifStatement185 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_Ident_in_question227 = new BitSet(new long[]{0x0000000000000080L});
	public static final BitSet FOLLOW_Colon_in_question229 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_String_in_question231 = new BitSet(new long[]{0x0000000D00000000L});
	public static final BitSet FOLLOW_type_in_question235 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_35_in_type254 = new BitSet(new long[]{0x0000000000010002L});
	public static final BitSet FOLLOW_computation_in_type264 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_32_in_type276 = new BitSet(new long[]{0x0000000000010002L});
	public static final BitSet FOLLOW_computation_in_type284 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_34_in_type296 = new BitSet(new long[]{0x0000000000010002L});
	public static final BitSet FOLLOW_computation_in_type304 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OParen_in_computation329 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_orExpr_in_computation333 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_CParen_in_computation335 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_OParen_in_primary396 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_orExpr_in_primary400 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_CParen_in_primary402 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_unExpr428 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_unExpr_in_unExpr432 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_25_in_unExpr443 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_unExpr_in_unExpr447 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_unExpr458 = new BitSet(new long[]{0x0000000003151410L});
	...
	public static final BitSet FOLLOW_unExpr_in_mulExpr513 = new BitSet(new long[]{0x0000000004800002L});
	public static final BitSet FOLLOW_set_in_mulExpr521 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_unExpr_in_mulExpr533 = new BitSet(new long[]{0x0000000004800002L});
	public static final BitSet FOLLOW_mulExpr_in_addExpr574 = new BitSet(new long[]{0x0000000003000002L});
	public static final BitSet FOLLOW_set_in_addExpr582 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_mulExpr_in_addExpr592 = new BitSet(new long[]{0x0000000003000002L});
	public static final BitSet FOLLOW_addExpr_in_relExpr627 = new BitSet(new long[]{0x00000000F8200002L});
	public static final BitSet FOLLOW_set_in_relExpr635 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_addExpr_in_relExpr651 = new BitSet(new long[]{0x00000000F8200002L});
	public static final BitSet FOLLOW_relExpr_in_andExpr689 = new BitSet(new long[]{0x0000000000400002L});
	public static final BitSet FOLLOW_22_in_andExpr695 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_relExpr_in_andExpr699 = new BitSet(new long[]{0x0000000000400002L});
	public static final BitSet FOLLOW_andExpr_in_orExpr734 = new BitSet(new long[]{0x0000001000000002L});
	public static final BitSet FOLLOW_36_in_orExpr740 = new BitSet(new long[]{0x0000000003151410L});
	public static final BitSet FOLLOW_andExpr_in_orExpr744 = new BitSet(new long[]{0x0000001000000002L});
	public static final BitSet FOLLOW_Else_in_synpred3_QL177 = new BitSet(new long[]{0x0000000000000002L});
}
