...
public class QLParser extends Parser {
    ...
    // $ANTLR start "primary"
    // QL.g:15:1: primary returns [Expr result] : ( Int | Ident | '(' x= orExpr ')' );
    ...
    // $ANTLR start "unExpr"
    // QL.g:21:1: unExpr returns [Expr result] : ( '+' x= unExpr | '-' x= unExpr | '!' x= unExpr |x= primary );
    public final Expr unExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:22:5: ( '+' x= unExpr | '-' x= unExpr | '!' x= unExpr |x= primary )
            int alt2=4;
            switch ( input.LA(1) ) {
            case 14:
                {
    ...
    // $ANTLR start "mulExpr"
    // QL.g:28:1: mulExpr returns [Expr result] : lhs= unExpr (op= ( '*' | '/' ) rhs= unExpr )* ;
    public final Expr mulExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:29:5: (lhs= unExpr (op= ( '*' | '/' ) rhs= unExpr )* )
            // QL.g:29:9: lhs= unExpr (op= ( '*' | '/' ) rhs= unExpr )*
            {
    ...
    // $ANTLR start "addExpr"
    // QL.g:41:1: addExpr returns [Expr result] : lhs= mulExpr (op= ( '+' | '-' ) rhs= mulExpr )* ;
    public final Expr addExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:42:5: (lhs= mulExpr (op= ( '+' | '-' ) rhs= mulExpr )* )
            // QL.g:42:9: lhs= mulExpr (op= ( '+' | '-' ) rhs= mulExpr )*
            {
    ...
    // $ANTLR start "relExpr"
    // QL.g:53:1: relExpr returns [Expr result] : lhs= addExpr (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpr )* ;
    public final Expr relExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:54:5: (lhs= addExpr (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpr )* )
            // QL.g:54:9: lhs= addExpr (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpr )*
            {
    ...
    // $ANTLR start "andExpr"
    // QL.g:77:1: andExpr returns [Expr result] : lhs= relExpr ( '&&' rhs= relExpr )* ;
    public final Expr andExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:78:5: (lhs= relExpr ( '&&' rhs= relExpr )* )
            // QL.g:78:9: lhs= relExpr ( '&&' rhs= relExpr )*
            {
    ...
    // $ANTLR start "orExpr"
    // QL.g:82:1: orExpr returns [Expr result] : lhs= andExpr ( '||' rhs= andExpr )* ;
    public final Expr orExpr() throws RecognitionException {
        ...
        try {
            ...
            // QL.g:83:5: (lhs= andExpr ( '||' rhs= andExpr )* )
            // QL.g:83:9: lhs= andExpr ( '||' rhs= andExpr )*
            {
