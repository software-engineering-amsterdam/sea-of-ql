...
public bool expected(str t, Expr expr:\intConst(_), VarMap vars) 
  = ((t == "int") || (t == "float"));
  
public bool expected(str t, Expr expr:\boolConst(_), VarMap vars) 
  = (t == "bool" );

public bool expected(str t, Expr expr:stringConst(_), VarMap vars) 
  = (t == "string" );

public bool expected(str t, Expr expr:floatConst(_), VarMap vars) 
  = (t == "float" );

public bool expected(str t, Expr expr:dateConst(_), VarMap vars) 
  = (t == "date" );
