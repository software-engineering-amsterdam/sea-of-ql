...
public class TestTypeLiterals extends TestBase {
	...
	public void testInt() throws RecognitionException {
		...
		assertEquals(new Integer(0), ((IntLiteral) parseDataType("0")).getValue());
		assertEquals(new Integer(1223), ((IntLiteral) parseDataType("1223")).getValue());
		assertEquals(new Integer(234234234), ((IntLiteral) parseDataType("234234234")).getValue());
	}
