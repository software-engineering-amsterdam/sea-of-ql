...
class BootstrapJavascriptGenerator {
	...
	public String render() {
		...
		// Generate functions and initial code and append them to the final
		// javascript code
		...
		for (final Ident ident : references.keySet()) {
			// If there is references to the identity, then generate a dispatch
			// method as we know there are dependencies on this identifier
