...
public class TypeErrorLog extends Log {
	 ...
	 * @param node node that has an invalid reference
	 ...
	 * @param handSide hand side that has the wrong type
	 * @param operator operator that has a hand side of the wrong type
	 */
	 ...
	 * @param handSide hand side that is not a boolean
	 * @param operator operator that has one hand side of the wrong type 
	 */
	 ...
	 * 
	 * @param node node that expects different types
