// $ANTLR 3.5 /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g 2013-02-15
// 15:20:54
...
public class QLParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "Bool", "COMMENT",
			"EscapedCharacterSequence", "Ident", "Int", "Money", "String", "Type", "WS", "'!'", "'!='", "'&&'", "'('",
			"')'", "'*'", "'+'", "'-'", "'/'", "':'", "'<'", "'<='", "'=='", "'>'", "'>='", "'else'", "'form'", "'if'",
			"'{'", "'||'", "'}'" };
	...
	// Syntax error reporter to use instead of the default (see:
	...
	// $ANTLR start "form"
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:75:1: form returns
	// [Form result] : formStatement= 'form' Ident '{' formStatements= statements '}' ;
	public final Form form() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:76:3:
			// (formStatement= 'form' Ident '{' formStatements= statements '}' )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:76:5:
			// formStatement= 'form' Ident '{' formStatements= statements '}'
			{
				formStatement = (Token) match(input, 29, FOLLOW_29_in_form66);
				if (state.failed)
					return result;
				Ident1 = (Token) match(input, Ident, FOLLOW_Ident_in_form68);
				if (state.failed)
					return result;
				match(input, 31, FOLLOW_31_in_form70);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				match(input, 33, FOLLOW_33_in_form76);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new Form((Ident1 != null ? Ident1.getText() : null), formStatements,
							getSyntaxPosition(formStatement));
				}
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:80:1: statements
	// returns [List<Statement> results] : ( statement )* ;
	public final List<Statement> statements() throws RecognitionException {
		List<Statement> results = null;

		final int statements_StartIndex = input.index();
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:82:3: ( (
			// statement )* )
			...
			// statement )*
			{
				...
				loop1: while (true) {
					...
					switch (alt1) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:82:6:
					// statement
					{
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:84:1: statement
	// returns [Statement result] : ( question | computation | ifStatement );
	public final Statement statement() throws RecognitionException {
		Statement result = null;

		final int statement_StartIndex = input.index();
		...
		try {
				...
				if ((LA2_1 == 22)) {
					...
					if ((LA2_3 == String)) {
						...
						if ((LA2_4 == Type)) {
							...
							if (((LA2_5 == EOF) || (LA2_5 == Ident) || (LA2_5 == 30) || (LA2_5 == 33))) {
								...
								try {
									...
									final NoViableAltException nvae = new NoViableAltException("", 2, 5, input);
									throw nvae;
								} finally {
							...
							try {
								...
								final NoViableAltException nvae = new NoViableAltException("", 2, 4, input);
								throw nvae;
							} finally {
								input.rewind(nvaeMark);
							}
						...
						try {
							...
							final NoViableAltException nvae = new NoViableAltException("", 2, 3, input);
							throw nvae;
						} finally {
							input.rewind(nvaeMark);
						}
			...
			switch (alt2) {
			case 1:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:85:7: question
			{
				...
				break;
			case 2:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:86:7:
			// computation
			{
				...
				break;
			case 3:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:87:7:
			// ifStatement
			{
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:89:1: ifStatement
	// returns [IfStatement result] : (line= ( 'if' '(' condition= orExpression ')' '{' successStatements= statements
	// '}' 'else' '{' elseStatements= statements '}' ) |line= ( 'if' '(' condition= orExpression ')' '{'
	...
	public final IfStatement ifStatement() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:5: (line= (
			// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
			// statements '}' ) |line= ( 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' ) )
			int alt3 = 2;
			...
			switch (alt3) {
			case 1:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:7: line= (
			// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
			// statements '}' )
			{
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:12: (
				// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
				// statements '}' )
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:13:
				// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
				// statements '}'
				{
					line = (Token) match(input, 30, FOLLOW_30_in_ifStatement161);
					if (state.failed)
						return result;
					line = (Token) match(input, 16, FOLLOW_16_in_ifStatement163);
					if (state.failed)
						return result;
					...
					if (state.failed)
						return result;
					line = (Token) match(input, 17, FOLLOW_17_in_ifStatement169);
					if (state.failed)
						return result;
					line = (Token) match(input, 31, FOLLOW_31_in_ifStatement171);
					if (state.failed)
						return result;
					...
					if (state.failed)
						return result;
					line = (Token) match(input, 33, FOLLOW_33_in_ifStatement177);
					if (state.failed)
						return result;
					line = (Token) match(input, 28, FOLLOW_28_in_ifStatement179);
					if (state.failed)
						return result;
					line = (Token) match(input, 31, FOLLOW_31_in_ifStatement181);
					if (state.failed)
						return result;
					...
					if (state.failed)
						return result;
					line = (Token) match(input, 33, FOLLOW_33_in_ifStatement187);
					if (state.failed)
						return result;
				}
				...
				break;
			case 2:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:94:7: line= (
			// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' )
			{
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:94:12: (
				// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' )
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:94:13:
				// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}'
				{
					line = (Token) match(input, 30, FOLLOW_30_in_ifStatement205);
					if (state.failed)
						return result;
					line = (Token) match(input, 16, FOLLOW_16_in_ifStatement207);
					if (state.failed)
						return result;
					...
					if (state.failed)
						return result;
					line = (Token) match(input, 17, FOLLOW_17_in_ifStatement213);
					if (state.failed)
						return result;
					line = (Token) match(input, 31, FOLLOW_31_in_ifStatement215);
					if (state.failed)
						return result;
					...
					if (state.failed)
						return result;
					line = (Token) match(input, 33, FOLLOW_33_in_ifStatement221);
					if (state.failed)
						return result;
				}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:99:1: computation
	// returns [Computation result] : id= Ident ':' String parameter= dataType '(' operation= orExpression ')' ;
	public final Computation computation() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:100:3: (id=
			// Ident ':' String parameter= dataType '(' operation= orExpression ')' )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:100:5: id=
			// Ident ':' String parameter= dataType '(' operation= orExpression ')'
			{
				id = (Token) match(input, Ident, FOLLOW_Ident_in_computation244);
				if (state.failed)
					return result;
				match(input, 22, FOLLOW_22_in_computation246);
				if (state.failed)
					return result;
				String6 = (Token) match(input, String, FOLLOW_String_in_computation248);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				match(input, 16, FOLLOW_16_in_computation254);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				match(input, 17, FOLLOW_17_in_computation260);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					final Ident ident = new Ident((id != null ? id.getText() : null), getSyntaxPosition(id));
					result = new Computation(ident, getUnquotedString((String6 != null ? String6.getText() : null)),
							parameter, operation, getSyntaxPosition(id));
				}
			}
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 5, computation_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:105:1: question
	// returns [Question result] : id= Ident ':' String parameter= dataType ;
	public final Question question() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:106:3: (id=
			// Ident ':' String parameter= dataType )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:106:5: id=
			// Ident ':' String parameter= dataType
			{
				id = (Token) match(input, Ident, FOLLOW_Ident_in_question278);
				if (state.failed)
					return result;
				match(input, 22, FOLLOW_22_in_question280);
				if (state.failed)
					return result;
				String7 = (Token) match(input, String, FOLLOW_String_in_question282);
				if (state.failed)
					return result;
				...
				if (state.backtracking == 0) {
					final Ident ident = new Ident((id != null ? id.getText() : null), getSyntaxPosition(id));
					result = new Question(ident, getUnquotedString((String7 != null ? String7.getText() : null)),
							parameter, getSyntaxPosition(id));
				}
			}
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 6, question_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:111:1: dataType
	// returns [DataType result] : Type ;
	public final DataType dataType() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:112:2: ( Type
			// )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:112:4: Type
			{
				Type8 = (Token) match(input, Type, FOLLOW_Type_in_dataType303);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					if ((Type8 != null ? Type8.getText() : null).equals("string"))
						result = new StringType();
					else if ((Type8 != null ? Type8.getText() : null).equals("integer"))
						result = new IntType();
					else if ((Type8 != null ? Type8.getText() : null).equals("money"))
						result = new MoneyType();
					else if ((Type8 != null ? Type8.getText() : null).equals("boolean"))
						result = new BoolType();
				}
			}
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 7, dataType_StartIndex);
			}
	...
	// $ANTLR start "primary"
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:119:1: primary returns
	// [Expression result] : ( Int | Money | Bool | Ident | String | '(' orExpression ')' );
	public final Expression primary() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:120:3: ( Int |
			// Money | Bool | Ident | String | '(' orExpression ')' )
			int alt4 = 6;
			switch (input.LA(1)) {
			case Int: {
				alt4 = 1;
			...
			switch (alt4) {
			case 1:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:120:5: Int
			{
				Int9 = (Token) match(input, Int, FOLLOW_Int_in_primary320);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new IntLiteral(Integer.parseInt((Int9 != null ? Int9.getText() : null)),
							getSyntaxPosition(Int9));
				}
			}
				break;
			case 2:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:121:5: Money
			{
				Money10 = (Token) match(input, Money, FOLLOW_Money_in_primary330);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new MoneyLiteral((Money10 != null ? Money10.getText() : null), getSyntaxPosition(Money10));
				}
			}
				break;
			case 3:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:122:5: Bool
			{
				Bool11 = (Token) match(input, Bool, FOLLOW_Bool_in_primary338);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new BoolLiteral(Boolean.parseBoolean((Bool11 != null ? Bool11.getText() : null)),
							getSyntaxPosition(Bool11));
				}
			}
				break;
			case 4:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:123:5: Ident
			{
				Ident12 = (Token) match(input, Ident, FOLLOW_Ident_in_primary346);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new Ident((Ident12 != null ? Ident12.getText() : null), getSyntaxPosition(Ident12));
				}
			}
				break;
			case 5:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:124:5: String
			{
				String13 = (Token) match(input, String, FOLLOW_String_in_primary354);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new StringLiteral(getUnquotedString((String13 != null ? String13.getText() : null)),
							getSyntaxPosition(String13));
				}
			}
				break;
			case 6:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:125:5: '('
			// orExpression ')'
			{
				match(input, 16, FOLLOW_16_in_primary362);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				match(input, 17, FOLLOW_17_in_primary366);
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = orExpression14;
				}
			}
				break;
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 8, primary_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:127:1: unExpression
	// returns [Expression result] : (op= '+' x= unExpression |op= '-' x= unExpression |op= '!' x= unExpression |x=
	// primary );
	public final Expression unExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:128:5: (op=
			// '+' x= unExpression |op= '-' x= unExpression |op= '!' x= unExpression |x= primary )
			int alt5 = 4;
			switch (input.LA(1)) {
			case 19: {
				alt5 = 1;
			...
			switch (alt5) {
			case 1:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:128:8: op= '+'
			// x= unExpression
			{
				op = (Token) match(input, 19, FOLLOW_19_in_unExpression387);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new Pos(x, getSyntaxPosition(op));
				}
			}
				break;
			case 2:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:129:8: op= '-'
			// x= unExpression
			{
				op = (Token) match(input, 20, FOLLOW_20_in_unExpression404);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new Neg(x, getSyntaxPosition(op));
				}
			}
				break;
			case 3:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:130:8: op= '!'
			// x= unExpression
			{
				op = (Token) match(input, 13, FOLLOW_13_in_unExpression421);
				if (state.failed)
					return result;
				...
				if (state.failed)
					return result;
				if (state.backtracking == 0) {
					result = new Not(x, getSyntaxPosition(op));
				}
			}
				break;
			case 4:
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:131:8: x=
			// primary
			{
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 9, unExpression_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:133:1: mulExpression
	// returns [Expression result] : lhs= unExpression (op= ( '*' | '/' ) rhs= unExpression )* ;
	public final Expression mulExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:134:5: (lhs=
			// unExpression (op= ( '*' | '/' ) rhs= unExpression )* )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:134:9: lhs=
			// unExpression (op= ( '*' | '/' ) rhs= unExpression )*
			{
				...
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:134:51:
				// (op= ( '*' | '/' ) rhs= unExpression )*
				loop6: while (true) {
					int alt6 = 2;
					...
					switch (alt6) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:134:53:
					// op= ( '*' | '/' ) rhs= unExpression
					{
						op = input.LT(1);
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 10, mulExpression_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:146:1: addExpression
	// returns [Expression result] : lhs= mulExpression (op= ( '+' | '-' ) rhs= mulExpression )* ;
	public final Expression addExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:147:5: (lhs=
			// mulExpression (op= ( '+' | '-' ) rhs= mulExpression )* )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:147:9: lhs=
			// mulExpression (op= ( '+' | '-' ) rhs= mulExpression )*
			{
				...
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:147:52:
				...
				loop7: while (true) {
					...
					switch (alt7) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:147:54:
					// op= ( '+' | '-' ) rhs= mulExpression
					{
						op = input.LT(1);
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 11, addExpression_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:159:1: relExpression
	// returns [Expression result] : lhs= addExpression (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs=
	// addExpression )* ;
	public final Expression relExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:160:5: (lhs=
			// addExpression (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpression )* )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:160:9: lhs=
			// addExpression (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpression )*
			{
				...
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:160:52:
				// (op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpression )*
				loop8: while (true) {
					int alt8 = 2;
					...
					switch (alt8) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:160:54:
					// op= ( '<' | '<=' | '>' | '>=' | '==' | '!=' ) rhs= addExpression
					{
						op = input.LT(1);
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 12, relExpression_StartIndex);
			}
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:184:1: andExpression
	// returns [Expression result] : lhs= relExpression (op= '&&' rhs= relExpression )* ;
	public final Expression andExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:185:5: (lhs=
			// relExpression (op= '&&' rhs= relExpression )* )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:185:9: lhs=
			// relExpression (op= '&&' rhs= relExpression )*
			{
				...
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:185:52:
				// (op= '&&' rhs= relExpression )*
				loop9: while (true) {
					int alt9 = 2;
					...
					switch (alt9) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:185:54:
					// op= '&&' rhs= relExpression
					{
						op = (Token) match(input, 15, FOLLOW_15_in_andExpression633);
						if (state.failed)
							return result;
						...
						if (state.failed)
							return result;
						if (state.backtracking == 0) {
							result = new And(result, rhs, getSyntaxPosition(op));
						}
					}
						break;
	...
	// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:188:1: orExpression
	// returns [Expression result] : lhs= andExpression (op= '||' rhs= andExpression )* ;
	public final Expression orExpression() throws RecognitionException {
		...
		try {
			...
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:189:5: (lhs=
			// andExpression (op= '||' rhs= andExpression )* )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:189:9: lhs=
			// andExpression (op= '||' rhs= andExpression )*
			{
				...
				// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:189:54:
				// (op= '||' rhs= andExpression )*
				loop10: while (true) {
					int alt10 = 2;
					...
					switch (alt10) {
					case 1:
					// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:189:56:
					// op= '||' rhs= andExpression
					{
						op = (Token) match(input, 32, FOLLOW_32_in_orExpression675);
						if (state.failed)
							return result;
						...
						if (state.failed)
							return result;
						if (state.backtracking == 0) {
							result = new Or(result, rhs, getSyntaxPosition(op));
						}
					}
						break;
			...
			// do for sure before leaving
			if (state.backtracking > 0) {
				memoize(input, 14, orExpression_StartIndex);
			}
	...
	public final void synpred4_QL_fragment() throws RecognitionException {
		...
		// 'if' '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
		// statements '}' ) )
		// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:7: line= ( 'if'
		// '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements= statements
		// '}' )
		{
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:12: ( 'if'
			// '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
			// statements '}' )
			// /Users/abort/Documents/UvA/Repository/abort/src/main/java/org/uva/sea/ql/parser/antlr/QL.g:90:13: 'if'
			// '(' condition= orExpression ')' '{' successStatements= statements '}' 'else' '{' elseStatements=
			// statements '}'
			{
				line = (Token) match(input, 30, FOLLOW_30_in_synpred4_QL161);
				if (state.failed)
					return;
				line = (Token) match(input, 16, FOLLOW_16_in_synpred4_QL163);
				if (state.failed)
					return;
				...
				if (state.failed)
					return;
				line = (Token) match(input, 17, FOLLOW_17_in_synpred4_QL169);
				if (state.failed)
					return;
				line = (Token) match(input, 31, FOLLOW_31_in_synpred4_QL171);
				if (state.failed)
					return;
				...
				if (state.failed)
					return;
				line = (Token) match(input, 33, FOLLOW_33_in_synpred4_QL177);
				if (state.failed)
					return;
				line = (Token) match(input, 28, FOLLOW_28_in_synpred4_QL179);
				if (state.failed)
					return;
				line = (Token) match(input, 31, FOLLOW_31_in_synpred4_QL181);
				if (state.failed)
					return;
				...
				if (state.failed)
					return;
				line = (Token) match(input, 33, FOLLOW_33_in_synpred4_QL187);
				if (state.failed)
					return;
			}
