...
class QLParser implements QLTokens {
	...
	private sea.ql.ast.ASTNode[] yysv;
	private sea.ql.ast.ASTNode yyrv;
	...
	public boolean parse() {
		...
		yysp = 0;
		yyst = new int[yyss];
		yysv = new sea.ql.ast.ASTNode[yyss];
	...
	protected void yyexpand() {
		...
		sea.ql.ast.ASTNode[] newyysv = new sea.ql.ast.ASTNode[2 * yyst.length];
