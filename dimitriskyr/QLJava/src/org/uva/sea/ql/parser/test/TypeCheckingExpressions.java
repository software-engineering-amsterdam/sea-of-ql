...
@Test//(expected=NullPointerException.class)
	public void testExprTypes() throws ParseError {
		assertEquals(false, CheckExpr.check(parser.parseExpression("(45 - 4 == 41)"),typeEnv, errormessages));
		assertEquals(false, CheckExpr.check(parser.parseExpression("(true && false) && true"),typeEnv, errormessages));
