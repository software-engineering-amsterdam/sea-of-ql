...
public class TestExpressions {
	...
	public void testNums() throws ParseError {
		assertEquals(parser.parse("0").getClass(), IntegerValue.class);
		assertEquals(parser.parse("1223").getClass(), IntegerValue.class);
		assertEquals(parser.parse("234234234").getClass(), IntegerValue.class);
	}
